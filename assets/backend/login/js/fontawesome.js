...
! function() {
    ...
    function D(t) {
        if (t && m) {
            ...
            return c.head.insertBefore(e, i),
                t
        }
    }
    var W = 0;
    ...
    function it(t) {
        ...
        G(r) && (y.transform = (u = (c = {
                ...
                p = c.startCentered,
                b = "",
                b += (v = void 0 !== p && p) && k ? "translate(" + (u.x / _ - d / 2) + "em, " + (u.y / _ - h / 2) + "em) " : v ? "translate(calc(-50% + " + u.x / _ + "em), calc(-50% + " + u.y / _ + "em)) " : "translate(" + u.x / _ + "em, " + u.y / _ + "em) ",
                b += "scale(" + u.size / _ * (u.flipX ? -1 : 1) + ", " + u.size / _ * (u.flipY ? -1 : 1) + ") ",
    ...
    var rt = function() {},
        ...
        st = function(t) {
            at.mark(ot + " " + t + " ends"),
                at.measure(ot + " " + t, ot + " " + t + " begins", ot + " " + t + " ends")
        },
        ft = {
            begin: function(t) {
    ...
    function wt(t) {
        var n, e = t.tag,
            ...
            a = t.children,
            o = void 0 === a ? [] : a;
        return "string" == typeof t ? q(t) : "<" + e + " " + (n = r,
    ...
    var zt = {
        replace: function(t) {
            ...
            if (e.parentNode && e.outerHTML)
                e.outerHTML = n + (S.keepOriginalSource && "svg" !== e.tagName.toLowerCase() ? "\x3c!-- " + e.outerHTML + " --\x3e" : "");
    ...
    var Ot = function(t) {
        ...
        return e && (n = e.split(";").reduce(function(t, e) {
                var n = e.split(":"),
                    i = n[0],
                    r = n.slice(1);
                return i && 0 < r.length && (t[i] = r.join(":").trim()),
                    t
            }, {})),
            n
    };
    var Mt = function(t) {
            var e, n, i, r, a = t.getAttribute("data-prefix"),
                ...
                f = bt(U(t));
            return a && o && (f.prefix = a,
                    f.iconName = o),
                f.prefix && 1 < s.length ? f.iconName = (i = f.prefix,
                    r = t.innerText,
                    dt[i][r]) : f.prefix && 1 === s.length && (f.iconName = (e = f.prefix,
                    n = function(t) {
        ...
        St = function(t) {
            ...
            return S.autoA11y && (n ? e["aria-labelledby"] = S.replacementClass + "-title-" + X() : e["aria-hidden"] = "true"),
                e
        },
        Pt = function(t) {
    ...
    function Ut(t) {
        var e, n, i, r, a, o, s, f, l, c, u, m, d, g, h, p, v, b, y, w = (n = Mt(e = t),
            i = n.iconName,
            r = n.prefix,
            a = n.rest,
            o = Ot(e),
                ...
                function() {
                    Y(t.querySelectorAll("*")).forEach(function(o) {
                        [":before", ":after"].forEach(function(e) {
                            ...
                            if (i && (i.nextSibling && -1 < i.nextSibling.textContent.indexOf(h) && Vt(i.nextSibling),
                                    Vt(i),
                                    i = null),
                                n && !i) {
                    ...
                    Object.keys(r).forEach(function(t) {
                        e.definitions[t] = O({}, e.definitions[t] || {}, r[t]),
                            function t(e, i) {
                                ...
                                "function" == typeof R.hooks.addPack ? R.hooks.addPack(e, n) : R.styles[e] = O({}, R.styles[e] || {}, n),
                                    "fas" === e && t("fa", i)
                            }(t, r[t])
                    })
                }
    ...
    function ne(t) {
        var e = t.prefix,
            ...
            i = t.iconName;
        if (i)
            return yt(re.definitions, n, i) || yt(R.styles, n, i)
    }
    var ie, re = new Qt,
        ae = (ie = function(t) {
                ...
                if (t) {
                    ...
                    return ee(O({
                        ...
                        return te(),
                            S.autoA11y && (l ? d["aria-labelledby"] = S.replacementClass + "-title-" + X() : d["aria-hidden"] = "true"),
                            nt({
                                icons: {
                                    main: Zt(b),
                                    mask: s ? Zt(s.icon) : {
    ...
    Object.defineProperty(oe, "config", {
        ...
        function(t) {
            ...
            u && (s.FontAwesome || (s.FontAwesome = oe),
                    I(function() {
                        0 < Object.keys(R.styles).length && se(),
                            S.observeMutations && "function" == typeof MutationObserver && function(t) {
                                if (f) {
                                    ...
                                    At = new f(function(t) {
                                            Nt || Y(t).forEach(function(t) {
                                                if ("childList" === t.type && 0 < t.addedNodes.length && !kt(t.addedNodes[0]) && (S.searchPseudoElements && o(t.target),
                                                        r(t.target)),
                                                    "attributes" === t.type && t.target.parentNode && S.searchPseudoElements && o(t.target.parentNode),
                                                    "attributes" === t.type && kt(t.target) && ~w.indexOf(t.attributeName))
                ...
                R.hooks = O({}, R.hooks, {
                    addPack: function(t, e) {
                        R.styles[t] = O({}, R.styles[t] || {}, e),
                            ht(),
                            se()
                    },
                    addShims: function(t) {
                        var e;
                        (e = R.shims).push.apply(e, M(t)),
                            ht(),
                            se()
                    }
                })
